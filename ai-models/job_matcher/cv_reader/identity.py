...
Converts a parsed CV profile into a rich identity vector used for
role-aware query building and semantic retrieval.
"""
...
def extract_identity(profile: dict, cv_text: str = "") -> dict:
    ...
    return {
        ...
        "query_tags": list(dict.fromkeys(query_tags))[:10],
    }
